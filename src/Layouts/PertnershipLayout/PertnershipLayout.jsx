            ...
            <div className="flex justify-between  gap-2 w-11/12 mx-auto pt-16">
                ...
                <div className="dash_b_right_bg" >
                   ...
                   <div className="col-span-4">
                        <h2 className="text-gray-600 text-xl font-bold">Pertnership</h2>
                    </div>
                            ...
                            bookingData.map((category, i) => {
                                return (
                                    <div className="w-full" key={i}>
                                        <Link to={`/pertner${category.route}`}><h2 onClick={() => handleMenuClick(category.title)} className={`h-8 w-full p-2 text-[15px] text-gray-600  flex items-center justify-center font-semibold  ${activeMenu === category.title ? "category_items_active" : ""}`}> {category.title}</h2></Link>
...
export default PertnershipLayout;
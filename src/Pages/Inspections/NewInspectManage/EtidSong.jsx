...
const EditSongDetails = ({ setActiveTab, singleSongData }) => {
  ...
  const { releaseTitle, subtitle, line, upcEan, isrc } = singleSongData;
  ...
  return (
    ...
    >
      ...
      <div className="button_box flex items-center justify-end p-2 mt-8">
